...
{
    public partial class FrmFerramentaPesquisarImagem : Form
    {
        #region Variaveis
        //formulario para passar imagem para produto
        FrmDadosProduto frmProduto = null;
        //formulario para passar imagem para encarte
        FrmFerramentaEncarte frmEncarte = null;
        ...
        #region Eventos
        public FrmFerramentaPesquisarImagem(FrmDadosProduto frm)
        {
            InitializeComponent();
        ...
        public FrmFerramentaPesquisarImagem(FrmFerramentaEncarte frm)
        {
            InitializeComponent();
            GlobalHelper.FinalizarThread();
            panelImagens.MouseWheel += panelImagens_MouseWheel;
        ...
        public FrmFerramentaPesquisarImagem()
        {
            InitializeComponent();
            GlobalHelper.FinalizarThread();
            pictureBoxImagem.Size = new Size(200, 179);
