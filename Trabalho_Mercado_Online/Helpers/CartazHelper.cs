...
namespace Trabalho_Mercado_Online.Helpers
{
    class CartazHelper
    {
        ...
        public static Bitmap CartazLinha2(string Linha1, string Linha2, string valor)
        {
            try
            {
                //Definições
                ...
                desenho.DrawString(Linha2, fontLinha2, new SolidBrush(Color.Black), 3508, 4000, stringFormat);
        ...
        public static Bitmap CartazLinha3(string Linha1, string Linha2, string Linha3, string valor)
        {
            try
            {
                //Definições
